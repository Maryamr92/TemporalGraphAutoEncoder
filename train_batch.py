...
def evaluate_model_list(model, input_tensor_list, adj_list_paraf, Rank, verbose=False):
    """
...
def evaluate_model_single(model, input_tensor, A_true, B_true, C_true, Rank, verbose=False):
    """
    Evaluate a trained TGCN model on given inputs.
